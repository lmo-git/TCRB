...
# 📌 Title
# ==========================
st.title("📦 โปรแกรมการนับพาเลทด้วย AI สำหรับโรงงาน TCRB")

# ==========================
# 1️⃣ ระบุเลขที่ใบคุมพาเลท
# ==========================
st.subheader("1️⃣ ระบุเลขที่ใบคุมพาเลท")
ocr_text = st.text_input("โปรดระบุเลขที่ใบคุมพาเลท (ไม่ต้องใส่ PT) เช่น 1234")

# ==========================
# 2️⃣ ถ่ายรูปเอกสาร
# ==========================
st.subheader("2️⃣ ถ่ายรูปเอกสารใบคุมพาเลท")
doc_image = st.camera_input("ถ่ายรูปเอกสารใบคุมพาเลท")

# ==========================
# 3️⃣ ถ่ายรูปพาเลท
# ==========================
st.subheader("3️⃣ ถ่ายรูปพาเลท")
pallet_image_file = st.camera_input("ถ่ายรูปพาเลท 1 ด้าน")

# ==========================
# 4️⃣ ตรวจจับจำนวนพาเลทด้วย AI
# ==========================
st.subheader("4️⃣ ตรวจจับจำนวนพาเลทด้วย AI")
...
# ==========================
# 5️⃣ ยืนยันจำนวนพาเลท
# ==========================
st.subheader("5️⃣ ยืนยันจำนวนพาเลท")
...
if st.button("✅ ยืนยันและบันทึกข้อมูล"):
    try:
        ...
        doc_link = upload_image(doc_image, "Document")
        pallet_link = upload_image(pallet_image_file, "Pallet")

        # === Save to Google Sheet ===
        timestamp = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        row = [timestamp, ocr_text, detected_count, pallet_count, doc_link, pallet_link]
